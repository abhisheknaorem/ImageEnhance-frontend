    ...
    <div className="w-full max-w-2xl mx-auto">
      {!previewUrl ? (
        <div
          ...
          onDrop={onDrop}
          className="border-2 border-dashed border-premium-300 rounded-3xl p-12 text-center cursor-pointer hover:border-premium-500 transition-all bg-white/50 backdrop-blur-sm group"
        >
          <input
            type="file"
            ref={fileInputRef}
            ...
            className="hidden"
          />
          <div className="bg-premium-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
            <Upload className="text-premium-600" size={28} />
          </div>
          <h3 className="text-xl font-semibold text-premium-800 mb-2">Upload Palatal Image</h3>
